...
(SAP Analytics Cloud) in an agile team
  - Coding in Java, Python, TypeScript, SQL and React
  - Delivering data import and export APIs
  - Adding multi-language support to SAC
  - Creating REST requests
  - Writing unit, acceptance and end-to-end tests
...
**English**: Native <br>
**Spanish**: Full professional proficiency<br>
